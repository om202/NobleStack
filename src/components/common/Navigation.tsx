    ...
    <>
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-4 pt-4 pointer-events-none">
        <div className="max-w-7xl mx-auto flex justify-center w-full">
          <div className="w-full sm:w-auto flex items-center justify-between sm:justify-center gap-2 sm:gap-4 py-2 px-3 sm:px-4 bg-[#121212]/90 border border-white/10 rounded-full shadow-2xl pointer-events-auto transition-all duration-300">
            {/* Logo Section */}
      ...
      {isMobileMenuOpen && (
        <>
          ...
          />
          <div className="min-[900px]:hidden fixed top-20 left-4 right-4 z-50 bg-[#121212]/90 border border-white/10 rounded-3xl shadow-2xl max-h-[calc(100vh-6rem)] overflow-y-auto transform transition-all duration-300 ease-out origin-top">

                ...
                <div className="relative z-10 max-w-4xl mx-auto px-4 py-20 text-center">
                    ...
                    <div className="mb-8 flex justify-center">
                        <div className="relative">
                            ...
                            <div className="relative w-24 h-24 md:w-32 md:h-32 bg-gradient-to-br from-cyan-500 to-teal-600 rounded-3xl flex items-center justify-center shadow-2xl">
                                <Smartphone className="w-12 h-12 md:w-16 md:h-16 text-white" strokeWidth={1.5} />
                            </div>
                        </div>
                    </div>

                    {/* Title */}
                    <h1 className="text-4xl md:text-6xl font-bold mb-6 text-main-theme bg-gradient-to-br from-cyan-600 to-teal-600 bg-clip-text text-transparent">
                        iOS & Android Apps
                    </h1>

                ...
                <div className="relative rounded-3xl overflow-hidden">
                    ...
                    <div className="relative z-10 p-12 text-center">
                        ...
                        <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
                            If you are looking for end-to-end automation systems that save time, reduce errors, and scale with your business, Noble Stack is ready to help. Schedule a free consultation and let's build intelligent automation that works for you.
                        </p>

  ...
  return (
    <section className="py-6 sm:py-8 md:py-10 lg:py-12 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-6 pr-10 border border-green-200 shadow-sm hover:shadow-md transition-shadow duration-300">
          {/* Close Button */}
          <button
          ...
          <div className="flex flex-col items-center text-center gap-6 pr-6">
            ...
            <div className="flex flex-col items-center gap-4">
              <span className="inline-flex items-center px-3 py-2 rounded-xl bg-emerald-100 text-emerald-700 text-sm font-semibold border border-emerald-200">
            ...
            <div className="flex justify-center">
              <Link 
                href="/Products"
                className="group flex items-center justify-center gap-2 px-12 py-3 w-full max-w-xs bg-gradient-to-r from-emerald-500 to-emerald-600 text-white rounded-xl hover:from-emerald-600 hover:to-emerald-700 transition-all duration-300 transform hover:-translate-y-0.5 font-semibold text-base shadow-md hover:shadow-lg"
              >
                Try Now
